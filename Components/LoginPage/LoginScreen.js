      ...
      <Container style={styles.container}>
        ...
        <Form style={styles.form}>
          <View>
            <Item fixedLabel style={{ marginLeft: 0 }}>
              <Input
                ...
                onChangeText={(e) => this.updateUserInput(e)}
          ...
          <View style={{ paddingBottom: 100 }}>
            <Item fixedLabel style={{ marginLeft: 0 }}>
              <Input
                ...
                onChangeText={(e) => this.updatePasswordInput(e)}
          ...
          <View>
            ...
            >
              <Text style={{ color: "#000", opacity: 1.0, fontSize: 18 }}>
                Log In
              </Text>
            </Button>
          </View>
...
export default connect(null, { fetchUserAuthToken })(LoginScreen);
